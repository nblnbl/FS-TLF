...
def main():
    ...
    parser.add_argument('--data_src_path', type=str, default='/data/jz/fzy/dataset/', help="Directory of downloaded raw dataset.")
    parser.add_argument('--data_dst_path', type=str, default='/data/jz/fzy/dataset/', help="Directory of processed dataset.")
